...
if(fs.length == 1)
{ 
return this.getFullYear() + fs + ((this.getMonth() + 1)>9?(this.getMonth() + 1):'0'+(this.getMonth() + 1) )+ fs + (this.getDate()>9?this.getDate():'0'+this.getDate()); 
}
fs = fs.replace("yyyy",this.getFullYear());
fs = fs.replace("mm",((this.getMonth() + 1)>9?(this.getMonth() + 1):'0'+(this.getMonth() + 1)));
fs = fs.replace("dd",this.getDate()>9?this.getDate():'0'+this.getDate());
return fs;
}
/************公用方法及变量**************/
var inputObj = null; 
